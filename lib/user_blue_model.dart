...
class User_blue {
  ...
  factory User_blue.fromMap(Map<String, dynamic> map) {
    return User_blue(
  ...
  factory User_blue.fromJson(String source) =>
      User_blue.fromMap(json.decode(source) as Map<String, dynamic>);
  ...
  @override
  bool operator ==(covariant User_blue other) {
